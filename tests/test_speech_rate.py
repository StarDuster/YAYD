...
def test_compute_scaling_ratio_clamps_voice():
    en = {"syllable_rate": 6.0}
    zh = {"syllable_rate": 12.0}
    ratio = compute_scaling_ratio(en, zh, voice_min=0.7, voice_max=1.3)
...
def test_apply_scaling_ratio_single_length_exact():
    ...
    ratio = {"voice_ratio": 1.25}
    y2, info = apply_scaling_ratio(y, sr, ratio)
